...
### 总结
在这门数据驱动作业课程中，我收获颇丰。首次在Python，VSCode中复现文章中的图表，第一次创建自己的数据分析网页，极大地提升了我的数据处理与展示能力，让我对数据驱动有了更深刻的理解，并且产生了利用工具处理问题的兴趣。

### 意见
课程更新较快，对于零基础的我，开始无法顺利使用一些高级数据分析工具和库时，配置环境和理解复杂代码参数。但是很感谢助教帮助和组员指导我。
